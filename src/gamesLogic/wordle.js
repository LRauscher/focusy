...
export function wordle(gamesContainer, gameFinishedCallback) {
    ...
    function handleGuess() {
        ...
        if (guess.length !== wordLength) {
            ...
            return; // Exit the function if the input length is incorrect
        }
        ...
        if (guess === correctWord) {
            ...
            submitButton.disabled = true;
            gamesContainer.innerHTML = `<p id="wrongGuess">Game over! The right word was ${correctWord}. Your highscore is: ${displayHighScore("wordle")} attempts.</p>`;
            gameFinished = true;
            setTimeout(() => {
                gameFinishedCallback(gameFinished);
                displayHighScore("wordle");
